        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
               ...
               <br>
               <br> 
              <h2 class="text-uppercase text-center mb-5">ADD NEW FOOD</h2>
              ...
              <form>
                ...
                <div class="form-outline mb-4">
                  <input type="text" id="name" name="name" placeholder="Name of foods" class="form-control form-control-lg" />
                </div>
                <div class="form-outline mb-4">
                ...
                <div class="form-outline mb-4">
                  <input type="text" id="price" name="price" placeholder="Price of foods" class="form-control form-control-lg" />
                </div>
